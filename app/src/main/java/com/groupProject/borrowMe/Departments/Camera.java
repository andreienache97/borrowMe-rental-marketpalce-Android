...
public class Camera extends AppCompatActivity {
    ...
    private static final String request_url = "https://myxstyle120.000webhostapp.com/departments/camera.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AdaptorItemDepartments adapter = new AdaptorItemDepartments(Camera.this, items);
