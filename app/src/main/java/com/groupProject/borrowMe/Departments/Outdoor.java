...
public class Outdoor extends AppCompatActivity {
    ...
    private static final String request_url = "https://myxstyle120.000webhostapp.com/departments/ourdoor.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AdaptorItemDepartments adapter = new AdaptorItemDepartments(Outdoor.this, items);
