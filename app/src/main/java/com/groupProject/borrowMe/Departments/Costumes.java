...
public class Costumes extends AppCompatActivity {
    ...
    private static final String request_url = "https://myxstyle120.000webhostapp.com/departments/costumes.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AdaptorItemDepartments adapter = new AdaptorItemDepartments(Costumes.this, items);
