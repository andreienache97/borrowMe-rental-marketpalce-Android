...
public class Toys extends AppCompatActivity {
    ...
    private static final String request_url = "https://myxstyle120.000webhostapp.com/departments/toys.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AdaptorItemDepartments adapter = new AdaptorItemDepartments(Toys.this, items);
