...
public class ItemSearch extends AppCompatActivity{
    ...
    String request_url ="https://myxstyle120.000webhostapp.com/SearchByWord.php";
...
//test
        ...
        sendRequest(searchWord, email);

    }


    public void sendRequest(final String searchWord,final String email) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AdaptorItemDepartments adapter = new AdaptorItemDepartments(ItemSearch.this, items,email);
