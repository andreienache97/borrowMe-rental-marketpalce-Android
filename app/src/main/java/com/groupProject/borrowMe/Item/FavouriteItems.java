...
import com.groupProject.borrowMe.adaptors.FavouriteItemsAdaptor;
...
/**
 * Created by Diana/Sebastian on 5/2/2018.
 */
...
public class FavouriteItems extends AppCompatActivity {
    ...
    List<FavouriteItem> requests;



    String request_url ="https://myxstyle120.000webhostapp.com/FavouriteItems.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.FavouriteAdapter);
        ...
        requests = new ArrayList<FavouriteItem>();
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                requests.add(new FavouriteItem(
                                        item.getString("item_id"),
                                        item.getString("Like_email"),
                                        item.getString("name")
                            ...
                            FavouriteItemsAdaptor adapter = new FavouriteItemsAdaptor(FavouriteItems.this, requests);
