...
public class BorrowedItems extends AppCompatActivity {
    ...
    String request_url ="https://myxstyle120.000webhostapp.com/borrowedItems.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            BorrowedItemsAdaptor adapter = new BorrowedItemsAdaptor(BorrowedItems.this, requests);
